import { createVerbs, type ReactVerbsConfig, type LendMarketConfig, type Asset } from '@eth-optimism/verbs-sdk/react'
...
export function createVerbsConfig(): ReactVerbsConfig<'turnkey'> {
  return {
    wallet: {
      hostedWalletConfig: {
        provider: {
